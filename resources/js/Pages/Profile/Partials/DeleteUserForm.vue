    ...
    <section class="space-y-6">
        <header>
            ...
            <p class="mt-1 text-sm text-gray-600">
                Quando sua conta for excluída, todos os seus recursos e dados
                serão excluídos permanentemente. Antes de excluir sua conta,
                faça o download de todos os dados ou informações que deseja
                manter.
            </p>
        </header>
        ...
        <Modal :show="confirmingUserDeletion" @close="closeModal">
            <div class="p-6">
                ...
                <p class="mt-1 text-sm text-gray-600">
                    Quando sua conta for excluída, todos os seus recursos e
